...
export default function UploadFile() {
  return (
         <div className="bg-white shadow w-[96%] h-full m-8 flex justify-center items-center">
        <div className="text-center">
          ...
          <h1 className="text-xl  mt-4">
            ...
            <span className='text-blue-500 text-2xl font-bold'>Click to Upload </span>or drag and drop
          </h1>
